    ...
    <Navbar bg="light" variant="light">
        <Container>
            ...
            <ul>
                    ...
                    <li><NavLink to ='/login/6'style={{paddingLeft: 13, textDecoration: 'none'}}>login</NavLink></li>
                    <li><NavLink to ='/signup/7'style={{paddingLeft: 13, textDecoration: 'none'}}>signup</NavLink></li>
                </ul>
        </Container>
      </Navbar>
